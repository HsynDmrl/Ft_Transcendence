...
export default function Play() {
    ...
    const draw = (ctx: CanvasRenderingContext2D) => {
        ...
        if (user) {
            ctx.font = "18px Arial";
            ctx.fillStyle = "#0077ff";
            ctx.fillText(`Player: ${user.firstName}`, 15, canvasHeight - 15);
        }
    };
    ...
    return (
        <div className="flex flex-col items-center mt-24 relative">
            <h1 className="text-4xl font-bold mb-6 text-blue-600">Ping Pong Oyunu</h1>

            {/* Skorlar - oyun alanının üstünde */}
            <div className="flex justify-center space-x-20 mb-2 text-xl font-bold w-full max-w-[800px]">
                <div className="text-blue-600">Player 1: {leftScore}</div>
                <div className="text-orange-500">Player 2: {rightScore}</div>
            </div>
            ...
            <p className="mt-4 text-gray-700">
                <strong>Kontroller:</strong> Sol raket W/S, Sağ raket Yukarı/Aşağı ok tuşları
            </p>
